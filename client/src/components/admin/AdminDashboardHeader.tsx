    ...
    <div className="lg:flex lg:items-center lg:justify-between bg-white p-4 rounded-md shadow mb-4">
      <div className="min-w-0 flex-1">
        ...
        {subtitle && (
          <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
            ...
            {/* Add more text/info badges here if desired */}
          </div>
        )}
      </div>
      <div className="mt-5 flex lg:ml-4 lg:mt-0">
        <span className="hidden sm:block">
          <button
            type="button"
            className="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm 
